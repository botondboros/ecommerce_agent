...
1. Takes your shopping list as input
2. Scrapes all 3 Hungarian online grocery stores simultaneously (Playwright)
3. Scores each store across 4 dimensions — price, delivery, quality, coverage
4. Uses Claude API to generate a natural-language summary and winner rationale
5. Fills the winning store's cart automatically
6. Renders a visual HTML dashboard with the full comparison
...
*Built by [Botond Boros](https://www.linkedin.com/in/botond-boros/) · March 2025*
